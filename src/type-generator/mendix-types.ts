...
export type GenerateTargetPlatform =
  | "web"
  | "native";
  ...
  switch (
    ...
    case "icon":
      ...
      if (
        ...
        type =
          "DynamicValue<WebIcon | NativeIcon>";
      }
      break;
    ...
    case "image":
      ...
      if (
        ...
        type =
          "DynamicValue<WebImage | NativeImage>";
      }
      break;
...
export function generateMendixImports(
  imports: string[],
): string {
  if (
    imports.length ===
