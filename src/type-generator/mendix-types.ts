...
function mapAssociationToMendixType(property: Property, imports: Set<string>): string {
...
function mapSelectionToMendixType(property: Property, imports: Set<string>): string {
